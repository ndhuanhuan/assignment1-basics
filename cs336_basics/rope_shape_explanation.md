...
| Tensor         | Shape (correct) | Shape (incorrect) | Notes                                   |
|----------------|-----------------|-------------------|------------------------------------------|
| x_even/x_odd   | (2, 4, 3)       | (2, 4, 3)         | Input split into feature pairs           |
| cos_pos/sin_pos| (2, 4, 3)       | (4, 3)            | Must match input shape for broadcasting  |
| token_positions| (2, 4)          | (4,)              | Must include batch dimension             |
...
---
```# filepath: /Users/ndhuanhuan/Workspace/assignment1-basics/cs336_basics/rope_shape_explanation.md
